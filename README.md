...
[![D4D Screen Shot][product-screenshot]](https://github.com/github_username/repo_name)
...
4. Install the necessary Node.js packages
   ...
   ```
5. Finally, run `windows_setup.py` or `mac_setup.py` and wait for it to create the D4D shortcut launcher `Dexcom 4 Desktop` in your project folder
   ```shell
